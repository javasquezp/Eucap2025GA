function RadiationPattern1 = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   RADIATIONPATTERN1 = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   RADIATIONPATTERN1 = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   RadiationPattern1 = importfile('RadiationPattern1.txt', 3, 7202);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2022/07/01 10:38:00
...
formatSpec = '%8f%16f%21f%20f%20f%20f%20f%20f%C%[^\n\r]';
...
RadiationPattern1 = table(dataArray{1:end-1}, 'VariableNames', {'Thetad','egPhideg','AbsDirdBi','AbsThetadBi','PhaseThetadeg','AbsPhidBi','PhasePhideg','AxRatiodB','VarName9'});
